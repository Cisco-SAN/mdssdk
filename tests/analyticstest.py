...
scsi_initiator_app_profile = {'protocol': 'scsi', 'metrics': [], 'view': 'scsi_initiator_app'}
scsi_target_tl_flow_profile = {'protocol': 'scsi', 'metrics': [], 'view': 'scsi_target_tl_flow'}
scsi_target_it_flow_profile = {'protocol': 'scsi', 'metrics': [], 'view': 'scsi_target_it_flow'}
scsi_initiator_it_flow_profile = {'protocol': 'scsi', 'metrics': [], 'view': 'scsi_initiator_it_flow'}
scsi_target_itl_flow_profile = {'protocol': 'scsi', 'metrics': [], 'view': 'scsi_target_itl_flow'}
scsi_initiator_itl_flow_profile = {'protocol': 'scsi', 'metrics': [], 'view': 'scsi_initiator_itl_flow'}
scsi_target_io_profile = {'protocol': 'scsi', 'metrics': [], 'view': 'scsi_target_io'}
scsi_initiator_io_profile = {'protocol': 'scsi', 'metrics': [], 'view': 'scsi_initiator_io'}

sw = Switch(ip_address="10.126.94.184", username="admin", password="nbv!2345", connection_type='https', port=8443,
